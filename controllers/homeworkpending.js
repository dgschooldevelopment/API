// This file should only contain the logic for handling requests, not route definitions
// Remove any route definitions from this file
const { collegesPool } = require('../config/dbconfig');

const homeworkpending = async (req, res) => {
    const { subjectName, standard, division } = req.body; // Assuming body for consistency
