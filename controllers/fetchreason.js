...
const fetchReasonByDate = async (req, res) => {
    try {
        ...
        const attendanceStatus = statusRows[0].status.toString(); // Ensure it's a string for comparison
        ...
        if (attendanceStatus === '1') {
            ...
            const [holidayRows] = await req.collegePool.query(query, [formattedDate]);
